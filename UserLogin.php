...
if(isset($_POST["Login"])){
	...
	$mysql = "SELECT email,password,userid FROM userinfo WHERE Email=:email AND password=:password";
	...
	if($query->rowCount() > 0) 
	{
		...
		echo "<script type='text/javascript'> document.location ='main.php'; </script>";	} else {
